...
void console_changefg()
{
fgcolor.r=77;
fgcolor.g=252;
fgcolor.b=7;
console_reset(&console);
console_init(console.gx);
}
void console_change_fgcolor(int r,int g,int b)
{
struct console_device *d=&console;
fgcolor.r=r;
fgcolor.g=g;
fgcolor.b=b;
graphics_fgcolor(d->gx, fgcolor);
graphics_bgcolor(d->gx, bgcolor);
//graphics_clear(d->gx,d->xpos,d->ypos, graphics_width(d->gx), graphics_height(d->gx));
}
/*
void change_bg()
{
...
console_putstring("\n\n");
//graphics_color fgcolor={255,255,255};
console_putstring("             _____________              \n");
console_putstring("            /             \\ \n");
console_putstring("           /   CAROS-111   \\ \n");
console_putstring("          /                 \\ \n");
console_putstring(" ________/    Version 1.0    \\__________\n");
console_putstring("|                                       |\n");
console_putstring("|                                       |\n");
console_putstring("|_______________________________________|\n");
console_putstring("      @@@@                     @@@@      \n");
console_putstring("\n\n");
	return (struct device *) &console;
//graphics_color fgcolor={77,252,7};
}
